...
//upperTiltUpperMotor.get()->SetName(UpperTilt", "UpperMotor");
    std::static_pointer_cast<Spark>(upperTiltUpperMotor)->SetName("UpperTilt", "UpperMotor");
   ...
   // lw->AddActuator("Bucket", "BucketMotor", std::static_pointer_cast<frc::Spark>(bucketBucketMotor));
    static_pointer_cast<Spark>(bucketBucketMotor)->SetName("Bucket", "BucketMotor");
   ...
   // lw->AddActuator("ClampTilt", "Motor", std::static_pointer_cast<frc::Spark>(clampTiltMotor));
    std::static_pointer_cast<frc::Spark>(clampTiltMotor)->SetName("ClampTilt", "Motor");
  ...
  //  lw->AddActuator("Clamp", "ClampMotor", std::static_pointer_cast<frc::Spark>(clampClampMotor));
    std::static_pointer_cast<frc::Spark>(clampClampMotor)->SetName("Clamp", "ClampMotor");
   ...
   // lw->AddSensor("Subsystem1", "PowerDistributionPanel 1", subsystem1PowerDistributionPanel1);
    subsystem1PowerDistributionPanel1->SetName("Power Distribution Panel");
    ...
    // lw->AddActuator("Winch", "winchMotor", std::static_pointer_cast<frc::Spark>(winchMotor));
     std::static_pointer_cast<frc::Spark>(winchMotor)->SetName("Winch", "winchMotor");
